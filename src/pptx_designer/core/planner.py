...
_TEMPLATES: dict[str, dict[str, Any]] = {
    "pitch": {
        ...
        "structure": [
            ...
            {"goal": "features", "title": "Key Features", "bullets": [
                "智能分析引擎",
                "实时协作平台",
                "自动化工作流",
            ]},
            {"goal": "data", "title": "Market Opportunity", "bullets": [
                "TAM: $50B global market",
                "SAM: $12B serviceable market",
                "SOM: $2B obtainable in 3 years",
            ]},
            {"goal": "content", "title": "Traction", "bullets": [
                "10,000+ active users",
                "$2M ARR, 15% MoM growth",
                "95% customer retention rate",
            ]},
            {"goal": "content", "title": "Team", "bullets": [
    ...
    "product": {
        ...
        "structure": [
            ...
            {"goal": "problem", "title": "Why This Matters", "bullets": [
                "Existing tools create friction",
                "Users demand better experience",
                "Market gap waiting to be filled",
            ]},
            {"goal": "solution", "title": "Introducing Our Product", "bullets": [
                "Seamless integration in 5 minutes",
                "AI-powered recommendations",
                "Beautiful, intuitive interface",
            ]},
            {"goal": "features", "title": "Core Capabilities", "bullets": [
                "智能推荐系统",
                "实时数据分析",
                "多平台同步",
            ]},
            {"goal": "data", "title": "Early Results", "bullets": [
                "3x faster than competitors",
                "98% uptime guaranteed",
                "SOC 2 Type II certified",
            ]},
            {"goal": "content", "title": "Customer Stories", "bullets": [
    ...
    "education": {
        ...
        "structure": [
            ...
            {"goal": "overview", "title": "Course Overview", "bullets": [
                "Duration: 8 weeks",
                "Level: Intermediate to Advanced",
                "Format: Video + Hands-on Labs",
            ]},
            {"goal": "content", "title": "Module 1: Foundations", "bullets": [
                "Core concepts and terminology",
                "Setting up your environment",
                "First project walkthrough",
            ]},
            {"goal": "content", "title": "Module 2: Deep Dive", "bullets": [
                "Advanced techniques",
                "Best practices and patterns",
                "Real-world case studies",
            ]},
            {"goal": "content", "title": "Module 3: Application", "bullets": [
                "Building production systems",
                "Performance optimization",
                "Deployment strategies",
            ]},
            {"goal": "content", "title": "Module 4: Mastery", "bullets": [
                "Architecture patterns",
                "Scaling and maintenance",
                "Future trends",
            ]},
            {"goal": "content", "title": "Learning Outcomes", "bullets": [
    ...
    "technical": {
        ...
        "structure": [
            ...
            {"goal": "overview", "title": "Architecture Overview", "bullets": [
                "Microservices architecture",
                "Event-driven communication",
                "Cloud-native deployment",
            ]},
            {"goal": "features", "title": "Core Components", "bullets": [
                "API Gateway",
                "Message Queue",
                "Data Pipeline",
            ]},
            {"goal": "code", "title": "Implementation", "bullets": [
                "# Example code block",
                "def process_data(input):",
                "    return transform(input)",
            ]},
            {"goal": "data", "title": "Performance Metrics", "bullets": [
                "Latency: p50=12ms, p99=45ms",
                "Throughput: 10,000 req/s",
                "Uptime: 99.99%",
            ]},
            {"goal": "content", "title": "Deployment Strategy", "bullets": [
    ...
    "minimal": {
        ...
        "structure": [
            ...
            {"goal": "content", "title": "Key Points", "bullets": [
                "Point one",
                "Point two",
                "Point three",
            ]},
            {"goal": "content", "title": "Details", "bullets": [
                "Elaboration on point one",
                "Supporting data",
            ]},
            {"goal": "content", "title": "Summary", "bullets": [
                "Main takeaway",
            ]},
